 ...
 */
namespace Drupal\googlelogin\Plugin\Network\auth;

use Drupal\googlelogin\Plugin\Network\service\Google_Utils;

use Drupal\googlelogin\Plugin\Network\exception\Google_AuthException;
use Drupal\googlelogin\Plugin\Network\Google_Client;
use Drupal\googlelogin\Plugin\Network\io\Google_HttpRequest;
  ...
  public function authenticate($service, $code = null) {
    ...
    if ($code) {
     // We got here from the redirect from a successful authorization grant, fetch the access token
      ...
      \Drupal::logger('googlelogin')->notice('entered');
