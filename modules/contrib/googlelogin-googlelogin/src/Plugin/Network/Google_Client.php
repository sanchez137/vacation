 ...
 */
namespace Drupal\googlelogin\Plugin\Network;
...
use Drupal\googlelogin\Plugin\Network\service\Google_Model;
use Drupal\googlelogin\Plugin\Network\service\Google_Service;
use Drupal\googlelogin\Plugin\Network\service\Google_ServiceResource;
use Drupal\googlelogin\Plugin\Network\auth\Google_AssertionCredentials;
use Drupal\googlelogin\Plugin\Network\auth\Google_Signer;
use Drupal\googlelogin\Plugin\Network\auth\Google_P12Signer;
use Drupal\googlelogin\Plugin\Network\service\Google_BatchRequest;
use Drupal\googlelogin\Plugin\Network\external\URITemplateParser;
use Drupal\googlelogin\Plugin\Network\auth\Google_Auth;
use Drupal\googlelogin\Plugin\Network\auth\Google_OAuth2;
use Drupal\googlelogin\Plugin\Network\cache\Google_Cache;
use Drupal\googlelogin\Plugin\Network\cache\Google_FileCache;
use Drupal\googlelogin\Plugin\Network\io\Google_IO;
use Drupal\googlelogin\Plugin\Network\io\Google_CurlIO;
use Drupal\googlelogin\Plugin\Network\service\Google_MediaFileUpload;
...
class Google_Client {
  ...
  public function __construct($config = array()) {
   ...
   // $cacheClass = $apiConfig['cacheClass'];
    self::$cache = new Google_FileCache();
    self::$auth = new Google_OAuth2();
    self::$io = new Google_CurlIO();
  }
